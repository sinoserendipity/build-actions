...
export Rootfs_partition_size="1004"            # 系统分区大小,每个机型默认值不一样 (填写您想要的数值,默认一般300左右,数值以MB计算，填0为不作修改),如果你不懂就填0
...
export Customized_Information="ImmortalWrt $(TZ=UTC-8 date "+%Y.%m.%d") Alan Build"  # 个性签名,你想写啥就写啥，(填0为不作修改)
